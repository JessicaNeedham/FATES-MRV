...
#export COMPSET=1850_DATM%GSWP3v1_ELM%CNPRDCTCBCTOP_SICE_SOCN_MOSART_SGLC_SWAV
...
./xmlchange RESUBMIT=3 # how many resubmits 
...
./xmlchange ELM_BLDNML_OPTS="-bgc fates -no-megan -no-drydep -nutrient_comp_pathway rd -soil_decomp century"
...
fates_paramfile='${PARAM_FILES}/fates_params_PA_nat.nc'
paramfile='/global/homes/j/jneedham/FATES-MRV/param_files/elm_params/MRV_elm_params.nc'
finidat='/pscratch/sd/j/jneedham/fates-mrv-runs/runs/v11/PA_AD_spinu.E45487965d0-F24e39f9d.2025-08-26/run/PA_AD_spinu.E45487965d0-F24e39f9d.2025-08-26.elm.r.0101-01-01-00000.nc'
use_fates=.true.
