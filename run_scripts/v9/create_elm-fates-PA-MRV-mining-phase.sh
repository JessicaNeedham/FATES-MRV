...
export TAG=PA_logging-mine_phase  # give your run a name
...
./xmlchange STOP_N=70 # how many years should the simulation run
./xmlchange RUN_STARTDATE='1950-01-01'
./xmlchange STOP_OPTION=nyears
./xmlchange REST_N=35 # how often to make restart files
...
fates_paramfile='${PARAM_FILES}/fates_params_PA_logging.nc'
...
fates_parteh_mode=2
nu_com='RD'
finidat='/pscratch/sd/j/jneedham/fates-mrv-runs/runs/v11/PA_post_AD_spinup.E45487965d0-F24e39f9d.2025-08-26/run/PA_post_AD_spinup.E45487965d0-F24e39f9d.2025-08-26.elm.r.0401-01-01-00000.nc'
hist_fincl1=
...
'FATES_SEEDS_IN', 'FATES_SEED_BANK', 'FATES_LITTER_IN', 
'FATES_LITTER_OUT', 'FATES_UNGERM_SEED_BANK', 'FATES_SEEDLING_POOL',
'FATES_REFORESTATION_PF', 'FATES_VEGC_APPF'
EOF
