...
export PARAM_FILES=/global/homes/j/jneedham/FATES-MRV/param_files/v3

export TAG=PA_ensemble_1_v3  # give your run a name
...
./xmlchange RESUBMIT=5 # how many resubmits 
