...
export TAG=PA_ssp5_reforest  # give your run a name
...
export SITE_BASE_DIR=/pscratch/sd/j/jneedham/fates-mrv-runs/climate-forcing/PA/ssp5_corr
...
fates_paramfile='${PARAM_FILES}/fates_params_2pfts_PA_refor.nc'
use_fates=.true.
