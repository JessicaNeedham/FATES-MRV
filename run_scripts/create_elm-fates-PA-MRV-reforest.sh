...
export TAG=PA_reforestation  # give your run a name
...
./xmlchange RESUBMIT=2 # how many resubmits 
...
fates_paramfile='${PARAM_FILES}/fates_params_2pfts_PA_reforestation.nc'
use_fates=.true.
...
finidat='/pscratch/sd/j/jneedham/fates-mrv-runs/runs/PA_mine_phase.Eddc844b10d-Fe7658331.2025-04-04/run/PA_mine_phase.Eddc844b10d-Fe7658331.2025-04-04.elm.r.1940-01-01-00000.nc'
hist_fincl1=
